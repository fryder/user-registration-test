...
@PageTitle("Userlist")
@Route(value = "userlist/:samplePersonID?/:action?(edit)", layout = MainLayout.class)
@Tag("userlist-view")
@JsModule("./views/userlist/userlist-view.ts")
@Uses(Icon.class)
public class UserlistView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEPERSON_ID = "samplePersonID";
    private final String SAMPLEPERSON_EDIT_ROUTE_TEMPLATE = "userlist/%d/edit";
    ...
    public UserlistView(@Autowired SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("userlist-view", "flex", "flex-col", "h-full");
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(UserlistView.class);
            }
        }
    }
